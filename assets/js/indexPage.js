...
for(let i=0;i<products.length;i++){
    if(i<4){
        proHtml += `<li class='col-md-3 col-sm-6 col-xs-12'>
                    <a href="./center.html">
...
for(let i=0;i<caseDetails.length;i++){
    if(i<4){
        caseHtml += `<li class='col-md-3 col-sm-6 col-xs-12'>
                        <img src="${caseDetails[i].img}" alt="case">
                        <div class='show-link'>
                            <span>${caseDetails[i].title}</span>
...
for(let i=0;i<newDetails.length;i++){
    if(i<2){
        newHtml += `<li>
                        <img src="${newDetails[i].img}" alt="new">
                        <div class='show-link'>
